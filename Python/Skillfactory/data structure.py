...
class LinkedList:  # класс списка
    ...
    def popleft(self):  # если список пустой возвращаем None
        if self.first is None:
            return None
        elif self.first == self.last:  # Если список содержит только один элемент
            node = self.first  # сохраняем его
            self.__init__()  # очищаем
            return node  # возвращаем сохраненный элемент
        else:  #
    ...
    def popright(self):
        if self.first is None:  # если список пустой возвращаем None
            return None
        elif self.first == self.last:  # Если список содержи 1 элемент
            node = self.first  # сохраняем
            self.__init__()  # очищаем
            ...
            pointer.next = None  # обнуляем указатель, чтобы
